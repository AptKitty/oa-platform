...
public class AdminService {
    ...
    private AdminDao getDao() { return MyBatisUtil.openSession(true).getMapper(AdminDao.class); }
    ...
    public void borrowAsset(AssetRecord record) {
        getDao().insertAssetRecord(record);
        getDao().updateAssetStatus(record.getAssetId(), "IN_USE");
    }
    public void returnAsset(AssetRecord record) {
        getDao().insertAssetRecord(record);
        getDao().updateAssetStatus(record.getAssetId(), "IDLE");
    }
